...
python3 main.py evaluate --model QuantTrio/Qwen3-30B-A3B-Instruct-2507-GPTQ-Int8 --benchmark aime25 --num-responses 50
...
python3 main.py evaluate --model Qwen/Qwen3-30B-A3B-Instruct-2507 --benchmark aime25 --num-responses 50
...
python3 main.py evaluate --model Qwen/Qwen3-30B-A3B-Instruct-2507-FP8 --benchmark aime25 --num-responses 50
